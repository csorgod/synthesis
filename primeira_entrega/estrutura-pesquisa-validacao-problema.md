...
**Pergunta central:** O problema investigado é real, relevante e merece ser resolvido?

**Frase-síntese (a completar ao final da investigação):**
...
> **Nota sobre separação de fatos e hipóteses:** Ao longo deste documento, dados e falas coletadas são tratados como evidências. Interpretações e suposições do grupo estão marcadas como *hipóteses* e apresentadas como análises, não como fatos.
...
Profissionais de marketing, fundadores e criadores de conteúdo tomam decisões recorrentes sobre campanhas, lançamentos e conteúdo sem conseguir validar previamente como sua audiência vai reagir.

As alternativas existentes apresentam barreiras concretas:

- **Pesquisa de mercado formal** custa entre R$30.000 e R$150.000 por projeto e leva de 3 a 4 semanas para ter resultados — inacessível para a maioria das empresas de médio porte e agências
- **Focus groups** têm custo médio de US$3.000–8.000 por sessão e amostras pequenas (8–12 pessoas)
- **Testes A/B tradicionais** só funcionam após o lançamento — quando o erro já custou verba de mídia e tempo
...
- **Intuição e experiência** são a alternativa mais usada — e a mais arriscada em cenários com orçamento de mídia envolvido

### Por que ela é relevante?

A consequência de decidir sem validação de audiência se manifesta de formas concretas: campanhas que não convertem, produtos que não encontram demanda, budget de mídia desperdiçado, e oportunidades perdidas para a concorrência que testou antes.

O problema não é novo — mas o contexto mudou. O custo de inferência de LLMs caiu **78% entre 2024 e 2025**, criando uma janela técnica e econômica para tornar a validação de audiência acessível a quem nunca teve budget para pesquisa formal.

No Brasil, a startup Galaxies já prova que grandes empresas (Nestlé, Boticário, Bradesco, Banco do Brasil) pagam para resolver essa dor com personas sintéticas — mas opera exclusivamente em projetos de R$150.000+, deixando o mercado de PMEs, agências médias e profissionais independentes completamente desatendido.

---

## 02. Hipóteses

> Suposições iniciais do grupo sobre o problema, a serem confirmadas, refutadas ou ajustadas com a pesquisa de campo.

### Hipótese 1 — Sobre a dor
Profissionais de marketing e fundadores de empresas de médio porte enfrentam regularmente a necessidade de entender como sua audiência vai reagir a uma ideia, campanha ou produto — mas não conseguem fazer isso de forma rápida e acessível com as ferramentas disponíveis hoje.

### Hipótese 2 — Sobre as causas
A principal barreira não é falta de interesse em validar, mas o custo (pesquisa formal é cara demais) e o tempo (resultados chegam tarde demais para o ritmo de decisão do negócio).

### Hipótese 3 — Sobre a frequência
Esse problema acontece com frequência alta — ao menos uma vez por mês — para profissionais que gerenciam campanhas, lançamentos ou conteúdo de forma recorrente.

### Hipótese 4 — Sobre o impacto
O custo de lançar sem validação é percebido como um problema real e recorrente — não como "normal do mercado". Profissionais conseguem citar exemplos concretos de decisões que custaram dinheiro, tempo ou reputação por falta de validação prévia.

### Hipótese 5 — Sobre o comportamento do público
A alternativa mais usada hoje é a intuição ou a opinião interna da equipe — e as pessoas sabem que isso é insuficiente, mas não têm alternativa acessível.

### Hipótese 6 — Sobre o segmento mais afetado
...
| **Dor específica** | Validar thumbnail, título, formato ou tema antes de produzir e publicar |
...
Este entregável foca no segmento primário: **profissionais de marketing e fundadores de empresas de 5 a 200 funcionários no Brasil**, que tomam decisões recorrentes sobre campanhas e lançamentos sem acesso a validação de audiência acessível.

O segmento enterprise (grandes corporações com budget acima de R$150K para pesquisa) está fora do recorte — esse segmento já é atendido por players como a Galaxies.
...
**A dor foi confirmada?** [ ] Sim [ ] Parcialmente [ ] Não  
**Frequência relatada:**  
**Impacto concreto mencionado:**  
**O que faz hoje no lugar:**  
**Citações diretas (palavras exatas):**
> " "
